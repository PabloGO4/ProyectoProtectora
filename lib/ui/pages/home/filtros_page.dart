...
class AdoptarAnimalesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          nombreProtectora, // Nombre de la protectora en el AppBar
      ...
      body: Column(
        ...
        children: [
          // Texto "Adopciones" entre el AppBar y la cuadrícula de animales
          Padding(
          ...
          // Espacio flexible para la cuadrícula de animales
          Expanded(
            child: Padding(
